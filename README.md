...
**2. Gå gjennom https://tour.golang.org/basics/1 - Hvilke forskjeller ser du i forhold til programmeringsspråket Java?** 
   ...
   - Exporterte navn starter med stor bokstav , f.eks. "Pi" er expotert fra "math" pakken. Hvis man bruker "pi" bruker man ikke expoterte  
     navn og heller fra den interne pakken.
